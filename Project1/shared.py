...
# In shared.py, REPLACE the existing display_progress_dashboard function with this one:
...
def display_progress_dashboard(user_id):
    ...
    if time_period == "Last 30 Days":
        ...
        if custom_start and custom_end and custom_start <= custom_end:
            # Ensure date types are correct for comparison
    ...
    if filtered_data.empty:
        ...
        return # Stop if no data after filtering
